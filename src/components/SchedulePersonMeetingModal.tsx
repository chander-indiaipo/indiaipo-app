...
const SchedulePersonMeetingModal = ({ visible, onClose, onProceedToPayment }) => {
    ...
    const meetingCharge = 35000; // in INR
        ...
        >
            <View style={styles.overlay}>
                <View style={styles.modalContainer}>
                    <Text style={styles.title}>Schedule a In-Person Meeting</Text>
...
export default SchedulePersonMeetingModal;
