            ...
            <View style={{ flex: 1, backgroundColor: '#fff' }}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ paddingLeft: 10, justifyContent: 'flex-start', alignItems: 'center', marginTop: 30, flexDirection: 'row' }}>
                        <Text style={{ fontSize: 14, color: "#666", fontWeight: '500' }}>Personal Information</Text>
                    </View>

                    <View style={{ paddingLeft: 10, justifyContent: 'flex-start', alignItems: 'center', marginTop: 20, flexDirection: 'row' }}>
                        <View style={{ width: 35, height: 35, borderRadius: 300, backgroundColor: "#e9f0fb", justifyContent: 'center', alignSelf: 'center' }}>
                            <MaterialIcons
                                name="phone"
                                size={20}  // Enlarge the icon when focused
                                color={"#36454F"}
                        ...
                        <View style={{ paddingLeft: 20 }}>
                            ...
                            <Text style={{ fontSize: 14, color: "#36454F", fontWeight: '500' }}>8572005698</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ paddingLeft: 10, justifyContent: 'flex-start', alignItems: 'center', marginTop: 20, flexDirection: 'row' }}>
                        ...
                        <View style={{ paddingLeft: 20 }}>
                            ...
                            <Text style={{ fontSize: 14, color: "#36454F", fontWeight: '500' }}>mchander20@gmail.com</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ paddingLeft: 10, justifyContent: 'flex-start', alignItems: 'center', marginTop: 20, flexDirection: 'row' }}>
                        ...
                        <View style={{ paddingLeft: 20 }}>
                            <Text style={{ fontSize: 12, color: "#666" }}>Gender</Text>
                            <Text style={{ fontSize: 14, color: "#36454F", fontWeight: '500' }}>Male</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ paddingLeft: 10, justifyContent: 'flex-start', alignItems: 'center', marginTop: 20, flexDirection: 'row' }}>
                        ...
                        <View style={{ paddingLeft: 20 }}>
                            <Text style={{ fontSize: 12, color: "#666" }}>City</Text>
                            <Text style={{ fontSize: 14, color: "#36454F", fontWeight: '500' }}>Yamuna Nagar</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ paddingLeft: 10, justifyContent: 'flex-start', alignItems: 'center', marginTop: 20, flexDirection: 'row' }}>
                        ...
                        <View style={{ paddingLeft: 20 }}>
                            <Text style={{ fontSize: 12, color: "#666" }}>State</Text>
                            <Text style={{ fontSize: 14, color: "#36454F", fontWeight: '500' }}>Haryana</Text>
                        </View>
                    </View>

                    <View style={{ paddingLeft: 10, justifyContent: 'flex-start', alignItems: 'center', marginTop: 30, flexDirection: 'row' }}>
                        <Text style={{ fontSize: 14, color: "#666", fontWeight: '500' }}>Business Information</Text>
                    </View>
