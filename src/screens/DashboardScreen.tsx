...
class DashboardScreen extends Component<DashboardScreenProps, DashboardScreenState> {
    ...
    constructor(props: DashboardScreenProps) {
        ...
        this.onScheduleCallPress = this.onScheduleCallPress.bind(this);
    ...
    onScheduleCallPress() {
        Toast.show({
            ...
            text1: 'You will get a call shortly.',
            text2: 'Thank You'
        });
    }
            ...
            <>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ paddingLeft: 10, width: "80%" }}>
                                    ...
                                    <View style={{ alignSelf: "flex-start", marginTop: 10 }}>
                                        <TouchableNativeFeedback onPress={this.onScheduleCallPress} style={{ alignSelf: "flex-start" }}>
                ...
                <View style={{ width: "100%", padding: 10, }}>
                    ...
                    <View style={{ width: "100%", paddingHorizontal: 10 }}>
                        <View style={{ width: "100%", backgroundColor: "#f0f0f0", borderRadius: 10, paddingHorizontal: 10, paddingVertical:20 }}>

                            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                <Text style={{ fontSize: 16, fontWeight: '600', color: "#36454F" }}>Need help with anything at IndiaIPO?</Text>
                                <Text style={{ fontSize: 14, color: "#36454F", textAlign: 'center' }}>Your dedicated Relationship Manager is just a message away.</Text>
                            </View>

                            <View style={{ paddingHorizontal: 10, width: "100%", justifyContent: 'center', alignItems: 'center', marginTop: 10 }}>
                                <View style={{ backgroundColor: "#fff", borderRadius: 10, width: "100%", flexDirection: 'row', padding: 10, alignItems: 'center' }}>
                                    <View style={{ width: 50, aspectRatio: 1, borderRadius: 300 }}>
                                        <Image
                                            source={require('../assets/images/profile.png')} // Path to your local image
                                            style={{
                                                width: "100%", // Set width of the image
                                    ...
                                    <View style={{ paddingLeft: 15 }}>
                                        <Text style={{ fontSize: 14, fontWeight: '600', color: "#36454F" }}>Upendra Kumar</Text>
                                        <Text style={{ fontSize: 12, color: "#36454F" }}>Relationship Manager</Text>
                                    </View>
                                </View>
                                <View style={{ paddingHorizontal: 10, width: "100%", justifyContent: 'space-between', flexDirection: 'row', marginTop: 10 }}>
                                    <TouchableOpacity style={{ width: "47%" }}>
                                        <View style={{ width: "100%", backgroundColor: "#fff", borderWidth: 1, borderRadius: 10, borderColor: "#225cc7", flexDirection: 'row', padding: 3 }}>
                                            <View style={{ backgroundColor: "#225cc7", width: 35, height: 35, borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
                                                <Ionicons
                                                    name="call"
                                                    size={22}  // Enlarge the icon when focused
                                                    color={"#fff"}
                                            ...
                                            <View style={{ paddingLeft: 10, alignSelf: 'center' }}>
                                                <Text style={{ color: "#225cc7", fontSize: 14, fontWeight: 'bold', alignSelf: 'center' }}>Book a Call</Text>
                                            </View>
                                        </View>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={{ width: "47%" }}>
                                        <View style={{ width: "100%", backgroundColor: "#fff", borderWidth: 1, borderRadius: 10, borderColor: "#225cc7", flexDirection: 'row', padding: 3 }}>
                                            <View style={{ backgroundColor: "#25D366", width: 35, height: 35, borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
                                                <Ionicons
                                                    name="logo-whatsapp"
                                                    size={22}  // Enlarge the icon when focused
                                                    color={"#fff"}
                                            ...
                                            <View style={{ paddingLeft: 10, alignSelf: 'center' }}>
                                                <Text style={{ color: "#225cc7", fontSize: 14, fontWeight: 'bold', alignSelf: 'center' }}>Start a Chat</Text>
                                            </View>
                                        </View>
                                    </TouchableOpacity>
                                </View>
                ...
                <View style={{
                    ...
                    elevation: 5,
                    bottom: 15, right: 15,
                    borderRadius: 300, padding: 10
                }}>
                    <TouchableOpacity onPress={() => { this.props.navigation.navigate("ChatbotScreen") }}>
                        <Image
                            source={require('../assets/images/chatbot.png')} // Path to your local image
                            style={{
                                width: 35,
                                height: 35
                            }}
